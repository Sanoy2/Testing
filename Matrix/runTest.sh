...
matrixesNumber=$1
matrixesDimension=$2
testid="matrixes=$matrixesNumber;dimension=$matrixesDimension"

python_result_file="../results/pythonResults_$testid.txt"
dotnet_result_file="../results/dotnetResults_$testid.txt"
cpp_result_file="../results/cppResults_$testid.txt"
